  ...
  <div class="w-full h-fit max-w-sm bg-white shadow-xl rounded-2xl flex items-center flex-col relative px-6 sm:px-10
    ...
    <form class="w-full" method="post" id="registrationForm">
      ...
      <div class="flex justify-between flex-col items-center">
        <div class="w-full grow flex justify-between px-2 mb-6">
          <div data-quest-step-selected="true">
            <div>1</div>
            <span>Account</span>
          </div>
          <div data-quest-step-selected="false">
            <div>2</div>
            <span>Person</span>
          </div>
          <div data-quest-step-selected="false">
        ...
        <div class="w-full" data-quest-panel="true">
          <div class="w-full">
