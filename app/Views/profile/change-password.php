        ...
        <div class="pb-8">
          <div class="flex flex-wrap gap-4 sm:gap-6 md:gap-8">
            <div class="basis-full sm:basis-1/3 md:basis-1/3 lg:basis-1/4">
              ...
              <input class="default-input" type="password" id="password" name="password">
              <ul class="text-sm font-medium text-red-500 pl-2 pt-1">
                <?php renderValidationFieldMessages('password', $messages);?>
              </ul>
            </div>
            <div class="basis-full sm:basis-1/3 md:basis-1/3 lg:basis-1/4">
              <label class="default-input__label" for="newPassword"><?=_('New password')?></label>
              <input class="default-input" type="password" id="newPassword" name="newPassword">
              <ul class="text-sm font-medium text-red-500 pl-2">
                <?php renderValidationFieldMessages('newPassword', $messages);?>
              </ul>
            </div>
            <div class="basis-full sm:basis-1/3 md:basis-1/3 lg:basis-1/4">
              <label class="default-input__label" for="repeatPassword"><?=_('Repeat password')?></label>
              <input class="default-input" type="password" id="repeatPassword" name="repeatPassword">
              <ul class="text-sm font-medium text-red-500 pl-2">
