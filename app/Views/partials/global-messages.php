...
<?php if (!empty($errors) || !empty($warnings) || !empty($hints) || !empty($success)):?>
  <ul class="w-full bg-white p-3 pb-0 md:rounded-md flex flex-col shadow-border mb-6" data-toast-parent>
    ...
    <?php foreach ($warnings as $message):?>
      <li class="flex items-center w-full px-4 py-2 mb-4 rounded-lg shadow border bg-orange-100/75 border-orange-500 text-orange-900"
          data-toast>
